            ...
            <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
                ...
                <div className='flex items-center gap-2 w-full'>
                    <label htmlFor="car-image">
                        <img src={image ? URL.createObjectURL(image) : assets.upload_icon} alt="image" className='h-14 rounde cursor-pointer' />
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                    ...
                    <div className='flex flex-col w-full'>
                        ...
                        <input type="number" placeholder='500' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.pricePerDay} onChange={(e) => setCar({...car, pricePerDay: e.target.value})} />
                    </div>
                    <div className='flex flex-col w-full'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                    ...
                    <div className='flex flex-col w-full'>
                        ...
                        <input type="number" placeholder='6' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.seating_capacity} onChange={(e) => setCar({...car, seating_capacity: e.target.value})} />
                    </div>
                </div>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <select onChange={(e) => setCar({...car, location: e.target.value})} value={car.location} className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
                        ...
                        <option value="New York">Agartala</option>
                    </select>
                </div>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <textarea 
                        rows={5}
                        placeholder='e.g. A luxurious SUV with a spacious interior and a powerful engine.' required 
